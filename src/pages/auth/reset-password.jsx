...
export function ResetPassword() {
    ...
    // Hitung step untuk progress indicator
                ...
                <CardBody className="p-8">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <Typography variant="small" color="gray">
                            {!isEmailSent && "Masukkan email Anda untuk menerima kode OTP"}
                            {isEmailSent && !isOtpSubmited && "Masukkan kode OTP yang dikirim ke email Anda"}
                            {isEmailSent && isOtpSubmited && "Buat password baru untuk akun Anda"}
                        </Typography>
                    </div>
                    ...
                    {isEmailSent && !isOtpSubmited && (
                        <form onSubmit={handleOtpSubmit}>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    setIsEmailSent(false); // 👈 FIX: ubah jadi false biar balik ke step 1
                                    setOtp(new Array(6).fill(""));
                                }}
                            >
                        ...
                        <form onSubmit={handlePasswordSubmit}>
                            <div className="mb-4">
                                <Input
                                    ...
                                    size="lg"
                                    label="Password Baru"
                                    value={newPassword} // 👈 FIX: ubah dari password ke newPassword
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    setIsOtpSubmitted(false); // 👈 FIX: ubah jadi false biar balik ke step 2
                                    setNewPassword("");
                                    setConfirmPassword("");
                                }}
                            >
                        ...
                        {[1, 2, 3].map((s) => (
                            <div
                                ...
                                className={`h-2 w-8 rounded-full transition-colors ${
                                    s === currentStep // 👈 FIX: pakai currentStep
                                        ? "bg-blue-500"
                                        : s < currentStep
                                            ? "bg-green-500"
                                            : "bg-gray-300"
